...
const BENETRIP_DESTINOS = {
  ...
  // Mostrar destino surpresa - LAYOUT OTIMIZADO
mostrarDestinoSurpresa() {
  ...
  console.log('Mostrando destino surpresa (layout otimizado):', destino);
  ...
  modalContainer.innerHTML = `
    <div class="bg-white rounded-lg w-full max-w-md relative modal-surpresa-content">
      <!-- Seção de imagem com altura controlada -->
      <div class="relative destino-imagem">
      ...
      <!-- Sistema de abas -->
      <div class="flex border-b border-gray-200 overflow-x-auto abas-surpresa">
      ...
      <div id="conteudo-surpresa-info" class="conteudo-aba-surpresa">
      ...
      <!-- Conteúdo da aba Pontos Turísticos -->
      <div id="conteudo-surpresa-pontos" class="conteudo-aba-surpresa hidden">
        ${destino.pontosTuristicos && destino.pontosTuristicos.length > 0 ? 
          destino.pontosTuristicos.map((ponto, idx) => {
            const imagem = this.encontrarImagemParaPontoTuristico(destino.imagens, ponto, idx);
            return `
      ...
      ${destino.clima && destino.clima.temperatura ? `
        ...
        <div id="conteudo-surpresa-clima" class="conteudo-aba-surpresa hidden">
          <div class="text-center bg-blue-50 p-4 rounded-lg">
            <h4 class="font-medium text-lg mb-2">Clima durante sua viagem</h4>
            <div class="text-4xl mb-2">🌤️</div>
      ...
      <!-- Conteúdo da aba Comentários -->
      <div id="conteudo-surpresa-comentarios" class="conteudo-aba-surpresa hidden">
        ${destino.comentario ? `
          <div class="bg-gray-50 p-4 rounded-lg">
            <div class="flex items-start gap-3">
              <div class="w-10 h-10 rounded-full overflow-hidden flex-shrink-0 bg-orange-100 border-2 border-orange-200">
      ...
      <!-- Botões de ação -->
      <div class="p-4 border-t border-gray-200 acoes-modal">
