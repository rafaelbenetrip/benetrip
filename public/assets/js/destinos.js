...
const BENETRIP_DESTINOS = {
  ...
  <div class="bg-white rounded-lg w-full max-w-md relative max-h-[90vh] flex flex-col modal-surpresa-content">
    ...
    <!-- Abas fixas -->
    <div class="flex border-b border-gray-200 overflow-x-auto flex-shrink-0 bg-white">
      <button id="aba-surpresa-info" class="botao-aba aba-ativa px-4 py-2 text-sm font-medium whitespace-nowrap" onclick="BENETRIP_DESTINOS.trocarAbaSurpresa('info')">
        Visão Geral
      </button>
      <button id="aba-surpresa-pontos" class="botao-aba aba-inativa px-4 py-2 text-sm font-medium whitespace-nowrap" onclick="BENETRIP_DESTINOS.trocarAbaSurpresa('pontos')">
        Pontos Turísticos
      </button>
      ${destino.clima && destino.clima.temperatura ? `
        <button id="aba-surpresa-clima" class="botao-aba aba-inativa px-4 py-2 text-sm font-medium whitespace-nowrap" onclick="BENETRIP_DESTINOS.trocarAbaSurpresa('clima')">
          Clima
        </button>
      ` : ''}
      <button id="aba-surpresa-comentarios" class="botao-aba aba-inativa px-4 py-2 text-sm font-medium whitespace-nowrap" onclick="BENETRIP_DESTINOS.trocarAbaSurpresa('comentarios')">
        Comentários
      </button>
    </div>
    
    <!-- Área de conteúdo com scroll contínuo -->
    <div class="flex-1 overflow-y-auto min-h-0">
      <!-- Conteúdo da aba Informações -->
      <div id="conteudo-surpresa-info" class="conteudo-aba-surpresa p-4">
        <!-- Conteúdo da aba visão geral aqui -->
