  ...
  criarCardVoo(voo, index) {
    ...
    cardVoo.innerHTML = `
      ...
      <div class="voo-card-header">
        <div class="voo-price">
          ${this.formatarPreco(preco, moeda)}
        ...
        <div class="flight-route">
          ...
          <div class="route-line">
            ...
            <div class="route-stops ${ehVooDireto ? 'route-stops-direct' : ''}">
              ${infoIda?.paradas === 0 ? 'Voo Direto' : `${infoIda?.paradas || 0} ${infoIda?.paradas === 1 ? 'parada' : 'paradas'}`}
            </div>
          </div>
          <div class="route-point">
      ...
      <div class="modal-content">
        <div style="padding: 16px;">
          <div class="flex justify-between items-center mb-4"> 
            <h3 style="font-size: 1.1rem; font-weight: 600; margin: 0;">Detalhes do Voo</h3> 
            <button id="btn-fechar-detalhes" style="background: none; border: none; cursor: pointer;">
          ...
          <div style="border-bottom: 1px solid #f3f4f6; padding-bottom: 12px; margin-bottom: 12px;"> 
            <div style="display: flex; justify-content: space-between; align-items: center;"> 
              <div> 
                <p style="font-size: 1.5rem; font-weight: 700; color: #E87722; margin: 0;">${this.formatarPreco(preco, moeda)}</p> 
                <p style="font-size: 0.8rem; color: #6c757d; margin: 0;">Preço por pessoa</p> 
              </div> 
              <div> 
                <p style="font-weight: 500; margin: 0;">${this.obterNomeCompanhiaAerea(voo.carriers?.[0])}</p> 
          ...
          <div style="margin-bottom: 16px;"> 
            <h4 style="font-weight: 500; margin-bottom: 8px;">Ida (${this.formatarData(infoIda?.dataPartida)})</h4> 
            <div style="margin-bottom: 16px;">${this.renderizarTimelineVoos(voo.segment?.[0]?.flight || [])}</div> 
          </div>
          
          ${infoVolta ? `
          <div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid #f3f4f6;"> 
            <h4 style="font-weight: 500; margin-bottom: 8px;">Volta (${this.formatarData(infoVolta?.dataPartida)})</h4> 
            <div>${this.renderizarTimelineVoos(voo.segment?.[1]?.flight || [])}</div> 
          </div>` : ''}
          
          <div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid #f3f4f6;"> 
            <h4 style="font-weight: 500; margin-bottom: 8px;">Info</h4> 
            <ul style="font-size: 0.9rem; padding-left: 20px;"> 
              <li>Bagagem de mão (1 peça)</li>
              <li>Refeição a bordo</li>
              <li style="color: #6c757d;">Bagagem despachada opcional</li>
            </ul> 
          </div>
          
          <div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid #f3f4f6; display: flex; justify-content: space-between;"> 
            <button id="btn-voltar-detalhes" style="padding: 8px 16px; border: 1px solid #e0e0e0; background: none; border-radius: 6px; cursor: pointer;">Voltar</button> 
            <button id="btn-selecionar-este-voo" style="padding: 8px 16px; background-color: #E87722; color: white; border: none; border-radius: 6px; cursor: pointer;">
              Selecionar Voo
            </button> 
          </div>
        </div>
    ...
    modalContainer.innerHTML = `
      <div class="modal-content">
        <div class="confirmacao-tripinha">
          ...
          <div> 
            <p style="font-weight: 700; margin: 0 0 8px 0;">Ótima escolha! Voo por ${precoFormatado}/pessoa.</p> 
            ${numPassageiros > 1 ? `
              <div style="background-color: rgba(255, 255, 255, 0.7); padding: 8px; border-radius: 6px;">
                <p style="font-size: 0.8rem; font-weight: 500; margin: 0 0 4px 0;">Resumo:</p>
            ...
            <p style="font-size: 0.8rem; color: #6c757d; margin: 12px 0 0 0;">Valor por pessoa (ida/volta). Próxima etapa: hospedagem.</p> 
          </div>
        </div>
